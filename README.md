...
- [x] Explain what a token is used for.
  ...
  tokens are used to prove a user has successfully logged in

- [x] What steps can you take in your web apps to keep your data secure?

  we can use private routes that check if a user has a token to access the data

- [x] Describe how web servers work.

  a web server contains a website that can be accessed through its ip or the domain set to that ip adress
